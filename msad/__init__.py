...
# Exponer funciones de integración para facilitar su uso
from msad.integration import (
    init_msad,
    shutdown_msad,
    create_backup,
    get_msad_status
...
# Hacer disponible la clase principal para uso avanzado
...
# Exponer funciones principales directamente desde el paquete
from msad.integration import init_msad, shutdown_msad, get_msad_status, create_backup

# Agregar función para crear el blueprint de MSAD directamente
def create_msad_blueprint():
    """
    Crea y devuelve un blueprint de Flask para las rutas de MSAD.
    Esta función permite evitar la necesidad de un archivo separado msad_routes.py
    """
